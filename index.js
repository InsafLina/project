...
$(document).ready(function(){
	...
	$('main').on('click', 'span', function() {
		...
		var imageNameLetters = arrSrc.slice(arrSrc.length - 9, arrSrc.length - 4);// get the src of the image as an array of letters 
		var imageName = imageNameLetters.join('');// get the src of the image as a string
	...
	$('#card').click(function(){
		  if (confirm('you have purchased the total of '+ sum +' TND') && sum >0) {
		      alert('Purchase confirmed !');
		      sum = 0;
		  } else if (sum ===0){
		  	 alert('You purchased nothing !');
		  }
